...
[`$http`]: http://docs.angularjs.org/ng.$http
[`$parsers`]: http://docs.angularjs.org/ng.directive:ngModel.NgModelController
[directive]: http://docs.angularjs.org/guide/directive
[`ng-change`]: http://docs.angularjs.org/ng.directive:ngChange
[`ng-checked`]: http://docs.angularjs.org/ng.directive:ngChecked
[`ng-class`]: http://docs.angularjs.org/ng.directive:ngClass
[`ng-click`]: http://docs.angularjs.org/ng.directive:ngClick
[`ng-disabled`]: http://docs.angularjs.org/ng.directive:ngDisabled
[`ng-false-value`]: http://docs.angularjs.org/ng.directive:input.checkbox
[`ng-form`]: http://docs.angularjs.org/ng.directive:form
[`ng-list`]: http://docs.angularjs.org/ng.directive:ngList
[`ng-maxlength`]: http://docs.angularjs.org/ng.directive:input
[`ng-minlength`]: http://docs.angularjs.org/ng.directive:input
[`ng-model`]: http://docs.angularjs.org/ng.directive:ngModel
[`ng-multiple`]: http://code.angularjs.org/1.0.8/docs/ng.directive:ngMultiple
[`ng-options`]: http://docs.angularjs.org/ng.directive:select
[`ng-pattern`]: http://docs.angularjs.org/ng.directive:input
[`ng-readonly`]: http://docs.angularjs.org/ng.directive:ngReadonly
[`ng-repeat`]: http://docs.angularjs.org/ng.directive:ngRepeat
[`ng-required`]: http://docs.angularjs.org/ng.directive:input
[`ng-selected`]: http://docs.angularjs.org/ng.directive:ngSelected
[`ng-switch`]: http://docs.angularjs.org/ng.directive:ngSwitch
[`ng-true-value`]: http://docs.angularjs.org/ng.directive:input.checkbox
