app.factory("OrderService", ['$http', function($http) {
    ...
    obj.getAllOrders = function() {
        return $http.get('http://api.sliceapp.co:6588/admin/orders');
        //return $http.get('http://localhost:8080/admin/orders');
    }

    obj.getOrderDetails = function(phone, number) {
        return $http.get('http://api.sliceapp.co:6588/admin/order/details?phone=' + phone + '&u=' + number);
        //return $http.get('http://localhost:8080/admin/order/details?phone=' + phone + '&u=' + number);
    }

    obj.deleteOrder = function(phone, number) {
        return $http.get('http://api.sliceapp.co:6588/admin/order/delete?phone=' + phone + '&u=' + number);
    ...
    obj.assignCourier = function(phone, number, courierName, courierPhone) {
        return $http.get('http://api.sliceapp.co:6588/admin/order/assign?phone=' + phone + '&u=' + number + '&cname=' + courierName + '&cphone=' + courierPhone);
    ...
    obj.setComplete = function(phone, number) {
        return $http.get('http://api.sliceapp.co:6588/admin/order/complete?phone=' + phone + '&u=' + number);
